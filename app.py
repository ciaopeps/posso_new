...
scheduler.add_job(func=to_app, trigger='interval', hours=3, start_date='2020-12-05 11:20:00', end_date='2100-06-15 09:05:00')
scheduler.add_job(func=to_app, trigger='interval', hours=3, start_date='2020-12-05 11:20:01', end_date='2100-06-15 11:00:00')
